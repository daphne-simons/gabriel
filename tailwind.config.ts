...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'new-moon': "url('/rock-slices/new-moon.webp')",
        'waxing': "url('/rock-slices/waxing.webp')",
        'first-quarter': "url('/rock-slices/first-quarter.webp')",
        'waxing-gibbous': "url('/rock-slices/waxing-gibbous.webp')",
        'full-moon': "url('/rock-slices/full-moon.webp')",
        'waning-gibbous': "url('/rock-slices/waning-gibbous.webp')",
        'last-quarter': "url('/rock-slices/last-quarter.webp')",
        'waning': "url('/rock-slices/waning.webp')",
