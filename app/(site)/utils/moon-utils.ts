...
export const MOON_PHASES = {
  ...
  WAXING_GIBBOUS: { id: 4, name: 'Waxing Gibbous', img: '/moon-imgs/waxing-g.webp', lightingRange: [53, 97] as [number, number], bgTheme: { particlesStars: 'bg-pStarsWaxingGibbous', bgColor: 'bg-skin-waxingGibbous', bgImg: 'bg-waxing-gibbous', textColor: 'text-googleLightGray', outlineColor: 'hover:outline outline-skin-waxingGibbous outline-[0.5px]', btnSearchBg: 'bg-btnSearchWaxingGibbous', hoverSearchBg: 'hover:bg-hoverSearchWaxingGibbous', logoColor: 'bg-phaseOrange' } },
  ...
  WANING_GIBBOUS: { id: 6, name: 'Waning Gibbous', img: '/moon-imgs/waning-g.webp', lightingRange: [53, 97] as [number, number], bgTheme: { particlesStars: 'bg-pStarsWaningGibbous', bgColor: 'bg-skin-waningGibbous', bgImg: 'bg-waning-gibbous', textColor: 'text-googleDarkGrayText', outlineColor: 'hover:outline outline-skin-waningGibbous outline-[0.5px]', btnSearchBg: 'bg-btnSearchWaningGibbous', hoverSearchBg: 'hover:bg-hoverSearchWaningGibbous', logoColor: 'bg-phaseOrange' } },
  LAST_QUARTER: { id: 7, name: 'Last Quarter', img: '/moon-imgs/last-q.webp', lightingRange: [49, 52] as [number, number], bgTheme: { particlesStars: 'bg-pStarsLastQuarter', bgColor: 'bg-skin-lastQuarter', bgImg: 'bg-last-quarter', textColor: 'text-googleLightGray', outlineColor: 'hover:outline outline-skin-lastQuarter outline-[0.5px]', btnSearchBg: 'bg-btnSearchLastQuarter', hoverSearchBg: 'hover:bg-hoverSearchLastQuarter', logoColor: 'bg-phasePink' } },
